...
const landingCopy = {
  en: {
    ...
    pricing: {
      ...
      coachName: 'Coach',
      coachPrice: '199.000',
      coachUnit: ' VND / month launch promo',
      coachDesc: 'List price 299.000 VND/month. Everything in Pro Individual, plus tools to run a client roster.',
      coachButton: 'Get launch price',
  ...
  vi: {
    ...
    pricing: {
      ...
      coachName: 'Coach',
      coachPrice: '199.000',
      coachUnit: ' VND / tháng ưu đãi ra mắt',
      coachDesc: 'Giá gốc 299.000 VND/tháng. Bao gồm mọi thứ trong Pro Individual, cộng thêm công cụ quản lý học viên.',
      coachButton: 'Nhận giá ưu đãi',
...
const polishedLandingCopyVi = {
  ...
  pricing: {
    ...
    coachPrice: '199.000',
    coachUnit: ' VND / tháng ưu đãi ra mắt',
    coachDesc: 'Giá gốc 299.000 VND/tháng. Dành cho huấn luyện viên cần giao giáo án, quản lý học viên và theo dõi tiến độ từ một dashboard tập trung.',
    coachButton: 'Nhận giá ưu đãi',
