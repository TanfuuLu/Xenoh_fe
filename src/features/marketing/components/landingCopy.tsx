import { TIER_PRICES } from '@/features/billing/types'
...
const landingCopy = {
  en: {
    ...
    hero: {
      ...
      title: <>Clear programs.<br />Training that stays on track.</>,
      lede: 'Xenoh keeps the plan, every training set, and post-session results in one journal. Lifters always know what to do next, while coaches track real progress without chasing messages or spreadsheets.',
    ...
    pricing: {
      ...
      userPrice: formatVnd(TIER_PRICES.ProIndividual[1]),
      userUnit: ' VND / month',
      ...
      coachTier: 'Coach',
      coachName: 'Coach',
      coachPrice: formatVnd(TIER_PRICES.ProCoach[1]),
      coachUnit: ' VND / month',
      coachDesc: 'Everything in Pro Individual, plus tools to run a client roster.',
      coachButton: 'Upgrade to Coach',
    ...
    cta: {
      title: <>Clear programs.<br />Training that stays on track.</>,
      desc: "Create a free account to get started, upgrade with User's Plan when you need more data, or try Coach if you manage clients.",
  ...
  vi: {
    ...
    hero: {
      ...
      title: <>Giáo án rõ ràng.<br />Buổi tập không lạc nhịp.</>,
      lede: 'Xenoh giữ kế hoạch, từng hiệp tập và kết quả sau buổi tập trong cùng một nhật ký. Người tập luôn biết mình cần làm gì tiếp theo, còn huấn luyện viên theo dõi được tiến độ thật mà không phải hỏi lại qua tin nhắn hay spreadsheet.',
    ...
    pricing: {
      ...
      coachPrice: formatVnd(TIER_PRICES.ProCoach[1]),
      coachUnit: ' VND / tháng',
      coachDesc: 'Bao gồm mọi thứ trong Pro Individual, cộng thêm công cụ quản lý học viên.',
      coachButton: 'Nâng cấp Coach',
