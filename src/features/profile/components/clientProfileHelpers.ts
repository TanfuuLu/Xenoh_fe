...
export function clientProfileText(lang: 'en' | 'vi') {
  return lang === 'vi'
    ? {
      ...
      proCoachRequired: 'Cần gói ProCoach đang hoạt động để tạo bài tập cho client.',
      exerciseSaveError: 'Không thể lưu bài tập. Vui lòng thử lại.',
    ...
    : {
      ...
      proCoachRequired: 'An active ProCoach subscription is required to create exercises for clients.',
